...
public class Optimizer : MonoBehaviour {
    ...
    public const int NUM_INPUTS = 8;
    public const int NUM_OUTPUTS = 5;
	...
	void Start () {
        ...
        champFileSavePath = Application.dataPath + string.Format("/Data/{0}.champ.xml", ExperimentName);
        popFileSavePath = Application.dataPath + string.Format("/Data/{0}.pop.xml", ExperimentName);       

        print(champFileSavePath);


	    Physics.IgnoreLayerCollision(LayerMask.NameToLayer("Blue"), LayerMask.NameToLayer("Blue"));
	    Physics.IgnoreLayerCollision(LayerMask.NameToLayer("Red"), LayerMask.NameToLayer("Red"));
    }
